...
export function ProjectsPodium({ topThree, isLoaded }: ProjectsPodiumProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-end justify-center gap-8 md:gap-4 mt-8">
      {/* 2nd Place (Desktop) / Mobile: Shown second */}
      <div
      ...
      {/* 1st Place (Desktop) / Mobile: Shown first */}
      <div
      ...
      {/* 3rd Place (Desktop) / Mobile: Shown third */}
      <div
