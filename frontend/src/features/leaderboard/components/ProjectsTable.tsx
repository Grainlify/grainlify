...
export function ProjectsTable({
  ...
  return (
    ...
    >
      ...
      {/* Desktop View (Table) */}
      <div className="hidden md:block backdrop-blur-[40px] bg-white/[0.12] rounded-[24px] border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden">
        {/* Table Header */}
          ...
          {data.map((project, index) => (
            ...
            >
              ...
              <div className="col-span-5 flex items-center gap-3">
                <div
                  className={`relative w-12 h-12 rounded-full bg-gradient-to-br ${getAvatarGradient(index)} flex items-center justify-center text-white font-bold text-[18px] shadow-md border-2 border-white/25 group-hover:scale-125 group-hover:shadow-lg group-hover:rotate-12 transition-all duration-300`}
                >
                  {project.logo}
                  {/* Glow ring on hover */}
